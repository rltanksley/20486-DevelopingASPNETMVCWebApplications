...
2. On the **Welcome to Adventure Works Photo Sharing! Use this site to share your adventures** page, press **F12** to open the Developer tools. Then right click on **Display** for any image and click **Inspect Element**.
3. Note that the URL does not include the name of the **Display** action method.
